...
import ledData from "../data/led.json";
import ledSiteData from '../data/led_site.json'
      ...
      <div className="home">
        ...
        {Object.keys(data).map((category, index) => (
          <div className="products-content">
            ...
            {ledSiteData[category] && ledSiteData[category].url && (
              <Link to={ledSiteData[category].url}>
